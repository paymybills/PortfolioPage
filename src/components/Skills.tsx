    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="scrub-reveal">
          <h4 className="text-[var(--accent-deep)] font-semibold mb-6 uppercase tracking-widest text-sm">
            Languages
          </h4>
          <ul className="text-slate-600 font-light space-y-3 text-sm">
            <li className="hover:text-[var(--accent-deep)] transition-colors duration-300 cursor-default">
              Python
            </li>
            <li className="hover:text-[var(--accent-deep)] transition-colors duration-300 cursor-default">
              C++
        ...
        <div className="scrub-reveal">
          ...
          <ul className="text-slate-600 font-light space-y-4 text-sm">
            <li>
              <span className="block text-slate-800 font-medium hover:text-[var(--accent-deep)] transition-colors duration-300">
