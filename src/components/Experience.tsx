    ...
    <section ref={containerRef} id="experience" className="section-padding">
      ...
      <div className="border-t-subtle py-12 flex flex-col md:flex-row justify-between gap-8 group">
        ...
        <div className="w-full md:w-1/2 scrub-reveal">
          ...
          <ul className="text-zinc-500 text-sm space-y-2 font-light">
            <li>
              — Designing highly scalable geospatial ML pipelines for
      ...
      <div className="border-t-subtle py-12 flex flex-col md:flex-row justify-between gap-8 group">
        ...
        <div className="w-full md:w-1/2 scrub-reveal">
          ...
          <ul className="text-zinc-500 text-sm space-y-2 font-light">
            <li>
              — Established best practices for experimentation and ablation
              studies.
            </li>
            <li>
              — Mentored junior members in software engineering and ML
              fundamentals.
            </li>
          </ul>
        </div>
